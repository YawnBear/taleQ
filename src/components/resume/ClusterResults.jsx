                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-100">
                                        <tr>
                                            ...
                                            <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Job Experience</th>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {group.candidates.map((candidate, candidateIndex) => (
                                            <tr key={`${index}-${candidateIndex}-${candidate.id || candidate.ID || candidate.name}`} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-3 py-2 text-sm text-gray-500">
                                                    {candidate.reason || candidate.matchReason || "No specific reason provided"}
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
