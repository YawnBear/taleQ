  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden bg-white border-2 border-gray-200 hover:border-green-600 transition-colors">
        <input
          ref={fileInputRef}
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
                ...
                <motion.div
                  ...
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit shrink-0 text-sm text-gray-600 bg-gray-50 shadow-sm">
                  ...
                  <div className="flex text-sm md:flex-row flex-col items-start md:items-center w-full mt-2 justify-between text-gray-600">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="px-1 py-0.5 rounded-md bg-gray-50">
                      {file.type}
                    </motion.p>
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-md border border-gray-200 hover:border-green-600 transition-colors"
                )}>
                {isDragActive ? (
                  <motion.p
                    initial={{ opacity: 0 }}
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute opacity-0 border border-dashed border-green-600 inset-0 z-30 bg-transparent flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md">
              </motion.div>
            )}
          </div>
        </div>
          ...
          return (
            <div
              ...
              className={`w-10 h-10 flex shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ? "bg-white"
                  : "bg-gray-50 shadow-[0px_0px_1px_3px_rgba(243,244,246,1)_inset]"
              }`}
            />
          );
        })
